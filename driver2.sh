...
do
    ...
    python check_trajectory.py --seq ${sequence} --gro em2.gro --cutoff 90
    sleep 2
    ...
    python check_trajectory.py --seq ${sequence} --gro nvt1.gro --cutoff 90
    sleep 2
    ...
    python check_trajectory.py --seq ${sequence} --gro npt1.gro --cutoff 90
    sleep 2
    ...
    python check_trajectory.py --seq ${sequence} --gro nvt2.gro --cutoff 90
    sleep 2
    ...
    python check_trajectory.py --seq ${sequence} --gro npt2.gro --cutoff 90
    sleep 2
